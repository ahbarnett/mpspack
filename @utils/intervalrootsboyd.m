function [x derr y u] = intervalrootsboyd(f, int, o)
...
% [x derr y u] = intervalrootsboyd(f, [a b], ...) also returns estimated errors
%   in the form of distances of roots from the real axis, the final set of
%   ordinates y, and function values u used.
%
...
if ~isfield(o, 'Nmax'), o.Nmax = 256; end
...
while N<o.Nmax && max(abs(F(1:2)))/max(abs(F))>o.Ftol  % large coeffs small?
