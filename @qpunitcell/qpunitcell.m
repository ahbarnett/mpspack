...
classdef qpunitcell < handle & domain
  ...
  methods
    ...
    function addqpuclayerpots(uc, opts) % ...................................
    ...
    %  makes 4 instances of qpuclayerpot and makes them influence the unit cell
      uc.bas = {uc.bas{:}, qpuclayerpot(uc, 'L', 'd'), qpuclayerpot(uc, 'L', 's'), qpuclayerpot(uc, 'B', 'd'), qpuclayerpot(uc, 'B', 's')};
      for i=0:3, uc.bas{end-i}.doms = uc; end  % make UC the affected domain
      uc.setupbasisdofs;
    end
