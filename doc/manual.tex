...
\item The Neumann-to-Dirichlet method for Dirichlet BCs of Barnett--Hassell, 2012.
\item The spectrally-weighed Dirichlet-to-Neumann method for Neumann BCs
...
the MPS approach to eigenvalues is not yet complete.
...
You should then be able to set {\tt o.FMM=1} in the final evaluation
section of \verb+test/testbvp_fmm.m+
and see an iterative solution. $N=10^4$ will take 9 second
to solve, and 0.5 sec to evaluate on the 0.01 grid, on a modern CPU.
...
Here is an old list of limitations and future ideas, from back in 2010:
...
\begin{verbatim}
Copyright (C) 2008 - 2016, Timo Betcke, Alex Barnett
