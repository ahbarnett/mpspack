...
command:
\co{svn co http://mpspack.googlecode.com/svn/branches/release-1.0 mpspack}
This creates a directory {\tt mpspack} containing the toolbox.

%TODO: CHANGE LINK TO TAG DIRECTORY AFTER RELEASE VERSION IS TAGGED 1.0
...
unpack this with
\co{tar zxvf mpspack-release-1.0.tar.gz}
This creates the directory {\tt mpspack} containing the toolbox.

%TODO: ALSO MAKE AVAILABLE ZIP ARCHIVE
